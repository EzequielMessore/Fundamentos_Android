...
public class ServiceOrderContract {
    ...
    public static final String[] COLUMNS = {ID, CLIENT, PHONE, ADDRESS, DATE, VALUE, PAID, DESCRIPTION, ACTIVE, USER_ID};
    ...
    public static ContentValues getContentValues(ServiceOrder serviceOrder) {
        ...
        content.put(USER_ID, serviceOrder.getUser().getId());
        return content;
    }
    ...
    public static ServiceOrder bind(Cursor cursor) {
        if (!cursor.isBeforeFirst() || cursor.moveToNext()) {
            ...
            User userPreference = SharedPreferenceUtil.getUserPreference();
            serviceOrder.setUser(userPreference == null ? new User() : userPreference);
            return serviceOrder;
        }
        return null;
    }
