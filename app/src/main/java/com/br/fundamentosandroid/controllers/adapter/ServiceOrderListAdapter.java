package com.br.fundamentosandroid.controllers.adapter;
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mImageViewMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MenuItem mi = popup.getMenu().findItem(R.id.action_archived);
                mi.setVisible(serviceOrder.isActive());
                MenuItem active = popup.getMenu().findItem(R.id.action_un_archiving);
                active.setVisible(!serviceOrder.isActive());
                popup.show();
            }
        });
    }
